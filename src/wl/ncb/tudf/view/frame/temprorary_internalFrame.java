...
public class temprorary_internalFrame extends JInternalFrame {
	private JTextField txtAsofDate;
	static Logger log = Logger.getLogger(temprorary_internalFrame.class.getName());
	ConnDB conndb;
	 ...
	 * Create the frame.
	 */
	public temprorary_internalFrame(String pUserName) {
	     ...
	     //   JFrame.setDefaultLookAndFeelDecorated(true);
	        ...
	        SwingUtilities.invokeLater(new Runnable() {
	            @Override
	            public void run() {
	            	temprorary_internalFrame gtw = new
	            			temprorary_internalFrame("FrmProcDataTUCRS");
