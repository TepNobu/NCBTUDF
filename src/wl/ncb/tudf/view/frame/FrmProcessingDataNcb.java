...
public class FrmProcessingDataNcb extends JInternalFrame  {
	...
	/*public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmProcessingDataNcb frame = new FrmProcessingDataNcb();
...
*/
	...
	public FrmProcessingDataNcb(String s) {
	...
	private void genTextFileNCB(String pAsOfMonth) {
		...
		//	String sql = "SELECT  SEGMENT_DETAIL,ITEMID FROM TUDF_AS_MONTH  WHERE ASOFDATE=? ORDER BY ITEMID ASC";
			...
			//System.out.println("As of Month:" + pAsOfMonth);

		//	ResultSet rs = conn.createStatement().executeQuery(sql);
			
		  PrintWriter writer = new PrintWriter("C:/NCBWL/textfile/TUCRS-WL-"+pAsOfMonth.substring(0, 4)+"-"+pAsOfMonth.substring(4)+".txt", "UTF-8");
			
			
		//  PrintWriter writer = new PrintWriter(new OutputStreamWriter("C:/NCBWL/textfile/TUCRS-WL-"+pAsOfMonth.substring(0, 4)+"-"+pAsOfMonth.substring(4)+".txt","Cp1252"));
		
		  //--- create PrintWriter with Windows encoding ---
	    //    PrintWriter con = new PrintWriter(new OutputStreamWriter(System.out, "Cp1252"), 
			  

			  while (rs.next()) {
				  
				//   progressBar.setValue((i/204000)*100);
      		...
      		/*	    progressBar.setStringPainted(true);
    			    ...
    			    getContentPane().add(progressBar, BorderLayout.NORTH);
    				    ...
    				    progressBar.setValue((i/totalrec)*100);
    				 ...
    				 */
			    	   ...
			    	   //    System.out.println(rs.getString("SEGMENT_DETAIL"));
			    	    
			    	       
			    	        writer.write(rs.getString("SEGMENT_DETAIL"));
			...
			/*byte b;
			RandomAccessFile f = new RandomAccessFile("C:/NCBWL/textfile/TUCRS-WL-"+pAsOfMonth+".txt", "rw");
